    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NutrientProfiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    NutrientProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingredients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ingredients_NutrientProfiles_NutrientProfileId",
                        column: x => x.NutrientProfileId,
                        principalTable: "NutrientProfiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_NutrientProfileId",
                table: "Ingredients",
                column: "NutrientProfileId");
